...
Core Team (2023), Gelfand (2022), and (\textbf{rohan?}).
...
Some of our data is of penguins (Figure~\ref{fig-marriage}), from
...
After the pendemic the number of marriage licences volatile compare to
the ggplot before the pendemic. Therefore, base on the ggplot we observe
the pendemic does affect the marriage licence.
